            ...
            <Row className="destination-box mb-2">
              ...
              <Form onSubmit={handleSubmit}>
                ...
                <section className="bg-gray modulo-mapaestado p-2">
                  ...
                  <p>Para crear tu cuenta es necesario que aceptes los <Link className='color-principal' to="/terminos-y-condiciones" target="_blank">Términos y condiciones generales</Link> de la plataforma</p>
                  <Form.Check
                    type="checkbox"
                    id="terminos"
